<%@ Page Title="" Language="C#" MasterPageFile ="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm10.aspx.cs" Inherits="master.WebForm10" %>
            ...
            <asp:Panel ID="Panel1" runat="server" Height="928px" Width="1289px">
                ...
                <table align="center" class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td class="auto-style4" style="background-color: #FFFF99;">
                            <asp:TextBox ID="TextBox2" runat="server" Height="35px" TextMode="Date" Width="309px"></asp:TextBox>
                        </td>
        ...
        <asp:Panel ID="Panel2" runat="server">
           <h2 align="center"><u>Details Of Candidate</u></h2>
            <table align="center" class="auto-style10">
                <tr>
                    <td class="auto-style20" style="border-style: solid; border-width: thin;">&nbsp; Name&nbsp;&nbsp; :-&nbsp;</td>
                    <td class="auto-style14" style="border-style: double; font-family: Elephant">
                        <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style20" style="border-style: solid; border-width: thin;">&nbsp; DOB&nbsp; :-</td>
                    <td class="auto-style14" style="border-style: double; font-family: Elephant">
                        <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style21" style="border-style: solid; border-width: thin;">&nbsp; Gender&nbsp; :-</td>
                    <td class="auto-style13" style="border-style: double; font-family: Elephant">
                        <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style20" style="border-style: solid; border-width: thin;">&nbsp; Address&nbsp; :-</td>
                    <td class="auto-style14" style="border-style: double; font-family: Elephant">
                        <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style20" style="border-style: solid; border-width: thin;">&nbsp; Phone No&nbsp; :-</td>
                    <td class="auto-style14" style="border-style: double; font-family: Elephant">
                        <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style20" style="border-style: solid; border-width: thin;">&nbsp; E-Mail :-</td>
                    <td class="auto-style14" style="border-style: double; font-family: Elephant">
                        <asp:Label ID="Label5" runat="server" Text="Label"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="border-style: solid; border-width: thin;">&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style20" style="border-style: solid; border-width: thin;">&nbsp; Qualification :-</td>
                    <td class="auto-style14" style="border-style: double; font-family: Elephant">
                ...
                <tr>
                    <td class="auto-style21" style="border-style: solid; border-width: thin;">&nbsp; Language&nbsp; :-&nbsp;</td>
                    <td class="auto-style13" style="border-style: double; font-family: Elephant">
